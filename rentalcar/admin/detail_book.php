...
<h3 style="color: white">Booking Detail</h3>
   ...
   <tr>
     ...
     <input type="hidden" name="id" value=" <?php echo ($numrow['book_id']); ?> " />
      ...
      <tr>
        ...
        <td><?php echo ucwords (strtolower($numrow['visit_date'])); ?> </td>
      </tr> 
    <tr>
  ...
  for ($a=0; $a<$numrow1; $a++) {
    ...
    <td>&nbsp;<?php echo ucwords (strtolower($row1['qty'])); ?></td>  
      ...
      <tr> 
        ...
        <input type="button" name="cancel" class = "button1" value=" Back " onclick="location.href='view_book.php'" /></td>            
