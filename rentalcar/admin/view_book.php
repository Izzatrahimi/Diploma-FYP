...
<div class="container">
  <br>
  <h3 style="color: white">PROCESSING BOOKING</h3>
	<?php
		$query = "SELECT * FROM book WHERE  status='processing' ORDER BY book_id";
...
<br>
  ...
  <h3 style="color: white">COMPLETED BOOKING</h3>
	<?php
		$query = "SELECT * FROM book  WHERE  status='complete' GROUP BY book_id";
		$result = mysqli_query($dbconn, $query) or die ("Error: " . mysqli_error($dbconn));
		$numrow = mysqli_num_rows($result);
	?>
   <tr align="left">
