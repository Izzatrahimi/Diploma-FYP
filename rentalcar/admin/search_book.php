...
<b style="margin-left: 15px; color: white;">Enter Booking ID</b>
<br><br>

<form name="form1" method="post" action="db_search_book.php" enctype="multipart/form-data">
    <table width="95%" border="0" align="center" style="margin-left: 10px">
      <tr>
        <td width="20%">Booking ID</td>  
        <td width="90%"><input type="text" name="search_book" size="50" /></td>
      </tr>  
       <tr> 
