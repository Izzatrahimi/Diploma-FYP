...
<div class="container">
  <br>
  <h3 style="color: white">Administrator Data</h3>
	<?php
   ...
   <tr align="left">
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
	  ...
	  ?>
        ...
        <td rowspan="2" width="5%" align="center"><a class="one" href="update_admin.php?user=<?php echo $row['id'];?>"><button class = "button1">Edit <i class="fa fa-edit"></i></button></a></td>
	  ...
	  ?>
        ...
        <td><?php echo ucwords (strtolower($row['address'])); ?></td>
        <td>&nbsp;<?php echo $row['phone']; ?></td>
        <td width="5%" align="center"><a class="one" href="update_admin.php?user=<?php echo $row['username'];?>"><button class = "button1">Detail</button></a></td>
      </tr>
	   <?php
	    $color="1";
	   }
   ...
   <tr align="left">
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
	  ...
	  ?>
        ...
        <td><?php echo ucwords (strtolower($row['address'])); ?></td>
        <td>&nbsp;<?php echo $row['phone']; ?></td>
        <td width="5%" align="center"><a class="one" href="update_user.php?id=<?php echo $row['id'];?>"><button class = "button1">Edit <i class="fa fa-edit"></i></button></a></td>
        <td width="5%" align="center"><a class="one" href="delete_user.php?id=<?php echo $row['id'];?>"><button class = "button1" onclick = "return confirm('Confirm Delete?')"><i class="fa fa-trash" ></i> Delete</button></a></td>
      </tr> 
      <?php 
       $color="2";}
	   else{
