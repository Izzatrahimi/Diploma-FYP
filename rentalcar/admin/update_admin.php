...
<h3 style="color: white">Update Admin Data</h3>
...
<form name="edit_user" method="post" action="db_update_admin.php" enctype="multipart/form-data">
    <table width="100%" border="0" align="center">
      <tr>
        <td width="16%">Name</td>  
        <td width="84%"><input type="text" name="name" size="50" value="<?php echo ucwords (strtolower($row['name'])); ?>" />
      </tr>  
      ...
      <tr>
        <td></td>
        <td colspan="2"><input type="submit" name="submit" class = "button1" value=" Save " />
