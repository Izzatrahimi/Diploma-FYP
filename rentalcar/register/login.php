    ...
    <div class="cont">
      <form method = "POST" action = "process.php">
        <div class="form sign-in">
            ...
            <p align="center">
                <a href="reset_password.php" class="a" data-replace="Forgot Password">Forgot Password</a>
            </p>
        </div>
      </form>
        <div class="sub-cont">
          ...
          <form method = "POST" action="db_add_user.php">
            <div class="form sign-up">
                ...
                <label>
                    ...
                    <input type="text" name = "phone" id = "phone" placeholder = "Example: 01X-XXXXXXXX" pattern="[0-9]{3}-[0-9]{7}" required>
                </label>
                <label>
                    <span>Email</span>
